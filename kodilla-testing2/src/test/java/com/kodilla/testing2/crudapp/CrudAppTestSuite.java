...
public class CrudAppTestSuite {
    ...
    public static final String BASE_URL = "https://rafalwkot.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("kotu83@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Trello4489");
        driverTrello.findElement(By.id("login")).submit();

        Thread.sleep(2000);

        driverTrello.findElements(By.xpath("//a[@class = \"board-tile\"]")).stream()
                .filter(aHref -> aHref.getText().equals("Kodilla Board"))
